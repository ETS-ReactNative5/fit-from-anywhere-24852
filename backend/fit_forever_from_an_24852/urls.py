"""fit_forever_from_an_24852 URL Configuration
...
urlpatterns = [
    ...
    path("", include("workout_plans.urls")),
    path("", include("resources_library.urls")),
]
...
api_info = openapi.Info(
    title="Fit Forever-From Anywhere API",
    default_version="v1",
    description="API documentation for Fit Forever-From Anywhere App",
)
